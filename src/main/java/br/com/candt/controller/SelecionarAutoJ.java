 ...
 * @author Phantom
 */
@WebServlet(name = "SelecionarAutoJ", urlPatterns = {"/SelecionarAutoJ"})
public class SelecionarAutoJ extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (search.isEmpty()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/LocaJ.jsp");
            dispatcher.forward(request, response);
