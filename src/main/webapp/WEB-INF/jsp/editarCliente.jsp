<%-- 
    ...
    Created on : 22/11/2017, 14:22:19
    Author     : Phantom
--%>
                            ...
                            <form action="./editarCliente" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control"  value="${sessionScope.usuario.CPF}"id="cpf" placeholder="CPF" name="cpf" maxlength="11">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                     ...
                                     <div class="form-group col-md-3">
                                        ...
                                        <input type="text " class="form-control"value="${sessionScope.usuario.CEP}" id="bairro" placeholder="Digite o CEP " name="bairro">
