                ...
                <div class="">
                    <div class="panel-heading">
                        <div class="panel-body">
                            <form action="./editarClienteJ" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="razaoS">Razão Social</label>
                                        <input name="razao" type="text"  id="razaoS"class="form-control "  value="${sessionScope.usuario.razaoSocial}"placeholder="Razão Social">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="nomeF">Nome Fantasia</label>
                                        <input name="nome" type="text"  id="nomeF"class="form-control" value="${sessionScope.usuario.nomeFantasia}" placeholder="Nome Fantasia">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inscricaoE">Inscrição Estadual</label>
                                        <input name="inscricaoE" type="text"  id="inscricaoE"class="form-control" value="${sessionScope.usuario.inscricaoEstadual}" placeholder="Inscrição Estadual">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="CNPJ">CNPJ</label>
                                        <input type="text" class="form-control" id="cnpj" placeholder="cnpj" disabled="true" value="<c:out value="${sessionScope.usuario.CNPJ}"/>" name="cnpj" maxlength="11">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control"  value="${sessionScope.usuario.end}"id="endereco" placeholder="endereco" name="endereco">
                                        </div>
                                        <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" value="${sessionScope.usuario.cidade}" id="cidade" placeholder="Digite sua cidade" name="cidade">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text " class="form-control" value="${sessionScope.usuario.complemento}" id="complemento" placeholder="Digite o complemento" name="complemento">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="bairro" class=" control-label ">Bairro</label>

                                        <input type="text " class="form-control" value="${sessionScope.usuario.bairro}"id="bairro" placeholder="Digite o bairro " name="bairro">

                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="bairro" class=" control-label ">CEP</label>

                                        <input type="text " class="form-control" value="${sessionScope.usuario.CEP}" id="bairro" placeholder="Digite o bairro " name="CEP">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-5 col-sm-offset-5">
                                        <input type="text" class="sla"  value="${sessionScope.usuario.CNPJ}"  name="atualCNPJ" >
